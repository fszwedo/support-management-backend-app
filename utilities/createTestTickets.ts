...
ticket = {
    ...
    "priority": "urgent",
    "subject": `Hello everyone, I was monitoring the EXD theme for my customers configurator and spotted some issues, can you please assess what is the problem? The configurator name is XYZ`
}
ticketPayload.push(ticket);
...
makeZendeskRequest('/api/v2/tickets/create_many', 'POST', { "tickets": ticketPayload })
